...
class Explicit implements BundlerInterface
{
    ...
    public function bundle()
    {
        ...
        $this->bundleAdditionalIncludes($bundle);
        return $bundle;
    }
    ...
    private function bundleAdditionalIncludes(Bundle $bundle)
    {
        foreach ($this->package->getAdditionalIncludes() as $additionalInclude) {
            $this->addPath($bundle, $this->package->getAbsolutePath($additionalInclude));
        }
    }
